...
{
  public class InventoryItemService : Service<InventoryItem>, IInventoryItemService
  {
    public InventoryItemService(Repository<InventoryItem> repisitory) : base(repisitory)
    {
    }
  }
}
