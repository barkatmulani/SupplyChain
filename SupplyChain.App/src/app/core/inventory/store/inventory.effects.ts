...
export class InventoryEffects {
  ...
  loadInventoryList$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  saveInventory$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  addInventory$: Observable<Action> = createEffect(() => this.actions$.pipe(
