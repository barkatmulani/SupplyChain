...
export class ReceiptEffects {
  ...
  loadReceipt$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  loadReceiptList$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  saveReceipt$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  addReceipt$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  deleteReceipt$: Observable<Action> = createEffect(() => this.actions$.pipe(
  ...
  postReceipt$: Observable<Action> = createEffect(() => this.actions$.pipe(
